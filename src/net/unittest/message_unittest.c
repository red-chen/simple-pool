...
void test_simple_message_all()
{
    ...
    TEST_EQUAL_STRING("01234567899876543210", simple_message_data(self));

    simple_message_clear(self);

     void* p3 = simple_message_pointer(self, 5);
    memcpy(p3, "01234", 5);

    TEST_EQUAL_INT(0, simple_message_size(self));
    simple_message_move(self, 5);
    TEST_EQUAL_INT(5, simple_message_size(self));

    void* p4 = simple_message_pointer(self, 5);
    memcpy(p4, "43210", 10);
    ...
    TEST_EQUAL_STRING("0123443210", simple_message_data(self));
